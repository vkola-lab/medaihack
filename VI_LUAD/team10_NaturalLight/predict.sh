...
TEAM=team10                   # same as YOUR_TEAM in README
CHECKPOINT=/projectnb/medaihack/team10/medaihack/VI_LUAD/checkpoints/fold_0.pth
...
python medaihack/VI_LUAD/predict.py \
    --team          $TEAM \
